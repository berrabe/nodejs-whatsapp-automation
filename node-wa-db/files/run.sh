...
echo -e "\n [+] RUN CUSTOM SQL FOR NODE WA BY BERRABE"
sed -i -- 's/db_otpwhatsapp/'"$WHATSAPP_DB_NAME"'/g' nodeDB.sql
/usr/bin/mysqld --user=mysql --bootstrap --verbose=0 --skip-name-resolve --skip-networking=0 < nodeDB.sql
echo -e "\n [+] DONE"
